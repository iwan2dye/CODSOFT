...
b1 = ttk.Button(main_window , text="1",  command= lambda : update("1") , width = 4  , style="TButton" )
b1.place(x=20 , y=90)

b2 = ttk.Button(main_window , text="2" , command= lambda : update("2") , width = 4 , style="TButton")
b2.place(x=110 , y=90)

b3 = ttk.Button(main_window , text="3" , command= lambda : update("3"), width = 4 ,  style="TButton")
b3.place(x=200 , y=90)

b4 = ttk.Button(main_window , text="4" , command= lambda : update("4"), width = 4 ,  style="TButton")
b4.place(x=290 , y=90)

b5 = ttk.Button(main_window , text="5" , command= lambda : update("5"), width = 4 ,  style="TButton")
b5.place(x=20 , y=170)

b6 = ttk.Button(main_window , text="6" , command= lambda : update("6"), width = 4 ,  style="TButton")
b6.place(x=110 , y=170)

b7 = ttk.Button(main_window , text="7" , command= lambda : update("7"), width = 4 ,  style="TButton")
b7.place(x=200 , y=170)

b8 = ttk.Button(main_window , text="8" , command= lambda : update("8"), width = 4 ,  style="TButton")
b8.place(x=290 , y=170)

b9 = ttk.Button(main_window , text="9" , command= lambda : update("9"), width = 4 ,  style="TButton")
b9.place(x=110 , y=250)

b10 = ttk.Button(main_window , text="0" , command= lambda : update("0"), width = 4 ,  style="TButton")
b10.place(x=200 , y=250)

b11 =ttk.Button(main_window , text="00" , command= lambda : update("00"), width = 4 ,  style="TButton")
...
b13 = ttk.Button(main_window , text="+" , command= lambda : update("+"), width = 4 ,  style="C.TButton")
b13.place(x=20 , y=330)


b14 = ttk.Button(main_window , text="-" , command= lambda : update("-"), width = 4 ,  style="C.TButton")
b14.place(x=110 , y=330)


b15 = ttk.Button(main_window , text="x" , command= lambda : update("*"), width = 4 ,  style="C.TButton")
b15.place(x=200 , y=330)


b16 = ttk.Button(main_window , text="÷" , command= lambda : update("/"), width = 4 ,  style="C.TButton")
b16.place(x=290 , y=330)


b19 = ttk.Button(main_window , text="%" , command= lambda : update("%"), width = 4 ,  style="C.TButton")
...
b16 = ttk.Button(main_window , text="C" , command= lambda : clear_all(), width = 4 ,  style="C.TButton")
...
b18 = ttk.Button(main_window , text="=" , command= lambda : solve(), width = 4 ,  style="Default.TButton")
...
b17 = ttk.Button(main_window , text="" , command= lambda : backspace() ,  style="C.TButton" , image=bksp_img)
